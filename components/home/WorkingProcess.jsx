...
const Circle = forwardRef(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-16 sm:size-24 text-xs sm:text-sm items-center text-black dark:text-white justify-center rounded-full border-2 bg-white dark:bg-[#194042] p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.5)] dark:shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function WorkingProcess() {
  ...
  return (
    <section className="py-10">
      ...
      <div
        className="relative flex py-10 sm:px-20 lg:px-40  w-full items-center justify-center overflow-hidden "
        ref={containerRef}
      >
        <div className="flex size-full flex-col max-w-full  items-stretch justify-between gap-10">
          ...
          <div className="flex flex-row items-center justify-between">
            ...
            <Circle ref={div6Ref}>{/* <Icons.zapier /> */} Testing </Circle>
          </div>
          <div className="flex flex-row items-center justify-between">
            <Circle ref={div3Ref}>
              {/* <Icons.whatsapp /> */}
            ...
            <Circle ref={div7Ref}>{/* <Icons.messenger /> */} Review</Circle>
          </div>
        </div>
