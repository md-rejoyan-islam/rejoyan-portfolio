    ...
    <section className="py-10">
      ...
      <div className="w-11/12 mx-auto">
        <div className=" grid grid-cols-12 gap-4 items-start">
          <div className="col-span-2 mt-3.5 flex flex-col items-center justify-center h-full">
            <p className="text-nowrap">November 2022 — Present</p>
          </div>
          ...
          <div className=" gap-10 mt-1 col-span-9 pb-6">
            <div>
              ...
              <p className="text-text-secondary">
                ...
                beautiful, responsive websites. I have a Bachelor of Science in
                Computer Science from the University of California, Riverside.
              </p>
