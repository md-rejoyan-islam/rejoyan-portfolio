  ...
  return (
    <div>
      ...
      >
        ...
        <span
          className={`inline-flex h-full py-2 w-full cursor-pointer items-center text-button justify-center rounded-lg bg-background px-5 text-sm font-medium  backdrop-blur-3xl gap-3 ${otherClasses}`}
        >
          {position === "left" && icon}
          {title}
          {position === "right" && icon}
